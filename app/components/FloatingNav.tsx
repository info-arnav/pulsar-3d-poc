...
export default function FloatingNav() {
  ...
  return (
    <nav className="fixed bottom-6 left-1/2 z-50 flex -translate-x-1/2 items-center gap-1 rounded-full border border-white/10 bg-black/60 p-1.5 shadow-2xl backdrop-blur-md">
      {links.map((link) => {
